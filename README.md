...
To build the final jar and optimize the luauTechStarter application for production, run:
...
Then navigate to [http://localhost:55786](http://localhost:55786) in your browser.
